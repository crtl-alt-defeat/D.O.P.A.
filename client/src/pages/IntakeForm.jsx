      ...
      questions: [
        {
          ...
          answers: [
            { text: "Literally me every single morning.", score: 3 },
            {
        ...
        },
        {
          ...
          answers: [
            { text: "Out of sight, out of mind is my entire life.", score: 3 },
        ...
        },
        {
          ...
          answers: [
            ...
            { text: "I literally live for showertime; I love it.", score: 1 },
          ],
        },
      ],
    },
      ...
      questions: [
        {
          ...
          answers: [
            { text: "Please stop attacking me like this.", score: 3 },
            {
        ...
        },
        {
          ...
          answers: [
            { text: "The basket is my closet now. Judge me.", score: 3 },
            {
        ...
        },
        {
          ...
          answers: [
            ...
            { text: "My space is clean and minimalist.", score: 1 },
          ],
        },
        {
          prompt:
        ...
        },
        {
          ...
          answers: [
            { text: "I have reached max dish-avoidance levels.", score: 3 },
      ...
      questions: [
        {
          ...
          answers: [
            ...
            { text: "Inbox Zero is my love language.", score: 1 },
          ],
        },
        {
          prompt:
          ...
          answers: [
            { text: "Panic is my only source of dopamine.", score: 3 },
            {
            ...
            { text: "I'm a planner. I finish things early.", score: 1 },
          ],
        },
        {
          prompt:
          ...
          answers: [
            { text: "My brain feels like 402.3 open browser tabs.", score: 3 },
            {
        ...
        },
        {
          ...
          answers: [
            { text: "I will literally cry over pants at 8:00 AM.", score: 3 },
            {
      ...
      questions: [
        {
          ...
          answers: [
            ...
            { text: "Affection is an automatic reflex for me.", score: 1 },
          ],
        },
        {
          prompt:
          ...
          answers: [
            ...
            { text: "I'm a lightning-fast replier.", score: 1 },
          ],
        },
        {
          prompt:
