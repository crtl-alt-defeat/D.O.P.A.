...
function SchedulesPage() {
  ...
  async function uncompleteGoal() {
    await markGoalIncomplete(selectedGoal.user_goal_id, token);
    await syncGoals();
  ...
  async function handleCompleteGoal() {
    await completeGoal(selectedGoal.user_goal_id, token); // ✅ uses users_goals.id
    await syncGoals();
    setSelectedGoal(null);
  }
      ...
      {selectedGoal && (
        <div className="popup-overlay" onClick={() => setSelectedGoal(null)}>
          <div className="popup" onClick={(e) => e.stopPropagation()}>
            ...
            <p>
              <strong>User Goal ID:</strong> {selectedGoal.user_goal_id}
            </p>{" "}
